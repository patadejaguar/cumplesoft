...
To build the final jar and optimize the cumpleSoft application for production, run:
...
Then navigate to [http://localhost:8064](http://localhost:8064) in your browser.
